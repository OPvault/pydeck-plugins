"""PDK shared module for no.pydeck.utilities.
...
from lib.core.paths import ROOT_DIR as _PROJECT_ROOT
...
_THROBBER_IMAGE = (
    "plugins/plugin/no.pydeck.utilities/assets/icons/throbber.gif"
)
...
def _start_script(
    ...
    try:
        from lib.buttons import button as button_lib
